...
export class CommonService {
  ...
  getDepartments(idClient: number) {
    return this.apiService.get(`${this.url}departmentdropdown`, { idClient });
  }

  getGenders(idClient: number) {
    return this.apiService.get(`${this.url}gendersdropdown`, { idClient });
  }
